\begin{spell}{Animate Dead}{PHB}{\nth{3} level necromancy}
{
    \spTime{1 minute}
    \spRange{10 feet}
    \spComponents{V, S, M (a drop of blood, a piece of flesh, and a pinch of bone dust)}
...
\note{At Higher Levels.} When you cast this spell using a spell
slot of \nth{4}~level or higher, you animate or reassert control
over two additional undead creatures for each slot level above
\nth{3}. Each of the creatures must come from a different corpse
or pile of bones.
\end{spell}