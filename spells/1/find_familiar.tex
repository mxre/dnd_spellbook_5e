\begin{spell}{Fiind Familiar}{PHB}{\nth{1} level conjuration (ritual)}
{
    \spTime{1 hour}
    \spRange{10 feet}
    \spComponents{V, S, M (10 gp worth of charcoal, incense, and herbs that must be consumed by fire in a brass brazier)}
